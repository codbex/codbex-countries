	...
	.controller('PageController', ($scope, EntityService, Extensions, ButtonStates) => {
		...
		$scope.loadPage = (pageNumber, filter) => {
			...
			EntityService.count(filter).then((resp) => {
				...
				request.then((response) => {
					...
					Dialogs.showAlert({
						title: 'Country',
						message: `Unable to list/filter Country: '${error.message}'`,
				...
				Dialogs.showAlert({
					title: 'Country',
					message: `Unable to count Country: '${error.message}'`,
					type: AlertTypes.Error
				});
				console.error('EntityService:', error);
			});
		...
		$scope.deleteEntity = (entity) => {
			...
			Dialog.showDialog({
				...
				message: `Are you sure you want to delete Country? This action cannot be undone.`,
				buttons: [{
					id: 'delete-btn-yes',
				...
				if (buttonId === 'delete-btn-yes') {
					EntityService.delete(id).then((response) => {
						...
						Dialogs.showAlert({
							title: 'Country',
							message: `Unable to delete Country: '${message}'`,
							type: AlertTypes.Error
						});
						console.error('EntityService:', error);
					});
